...
| 종류 | 링크 |
|---|---|
| **RAG 사례** | https://scvcoder-kpaa.hf.space/ |
| **MCP 사례** | https://github.com/scvcoder/korean-privacy-law-mcp |
...
| v1.2 | 2026-05-10 | 분야별 개인정보 보호 안내서(2024.12) 8개 편 전체 청킹 완료 (246 → **476청크**, +230). 통계작성 54 + 공공기관 48 + 온라인 경품행사 16 신규 추가. 총 레코드 2,202 → **2,432**. CHANGELOG.md 신설 + git tag v1.2. |
| v1.3 | 2026-09-13 | 2026년 PIPC 신규 가이드 3종 추가 (+267청크): 가명정보 처리 가이드라인(2026.3) 본권 46 + 별권 86 = **132**, 개인정보 처리방침 작성지침(2026.4) **96**, 공공 AX 프라이버시 보호 안내서(2026.7) **39**. 총 레코드 2,432 → **2,699**. 기존 가이드 4종·상담사례 1,745건은 원출처 대조 결과 변경 없음. |

전체 변경이력은 [CHANGELOG.md](CHANGELOG.md) 참조.
...
- 분야별 개인정보 보호 안내서(2024.12).pdf — 8개 편 전체 청킹 완료 (인사·노무 / 사회복지시설 / 의료기관 / 약국 / 학원·교습소 / 통계작성 / 공공기관 / 온라인 경품행사)
- 가명정보 처리 가이드라인(2026.03.).pdf — [본권] 가명정보 제도 안내편 + [별권] 가명정보 제도 실무편 (v1.3 신규)
- 2026 개인정보 처리방침 작성지침.pdf — 본문 + 부록 9종 (생성형 AI 서비스·아동·공공기관·소상공인·업종별 등) (v1.3 신규)
- 공공 AX 프라이버시 보호 안내서(2026.7.).pdf (v1.3 신규)
...
| 분야별_개인정보_보호_안내서(2024.12).jsonl | `guide` | 476 | PIPC 공식 가이드 PDF — 8개 편 전체 (인사·노무·사회복지시설·의료기관·약국·학원·교습소·통계작성·공공기관·온라인 경품행사) | 2024.12 |
| 가명정보_처리_가이드라인(2026.3).jsonl | `guide` | 132 | PIPC 공식 가이드 PDF — 본권(제도 안내편) 46 + 별권(제도 실무편) 86, `pages` 에 `본권 p.N`/`별권 p.N` 구분 | 2026.03 |
| 개인정보_처리방침_작성지침(2026.4).jsonl | `guide` | 96 | PIPC 공식 가이드 PDF — 본문(기재사항 24개 항목·공개 방법·라벨링) + 부록 9종 | 2026.04 |
| 공공_AX_프라이버시_보호_안내서(2026.7).jsonl | `guide` | 39 | PIPC 공식 가이드 PDF | 2026.07 |
...
| `pages` | string | 책의 페이지 번호 (예: `"p.3"`, `"p.12-14"`; 가명정보 처리 가이드라인은 `"본권 p.3"` / `"별권 p.9"`, 안내사항 등 앞표지 부분은 `"front"`) |
...
5. 개인정보보호위원회, 「가명정보 처리 가이드라인」 2026.03.
6. 개인정보보호위원회, 「개인정보 처리방침 작성지침」 2026.4.
7. 개인정보보호위원회, 「공공 AX 프라이버시 보호 안내서」 2026.7.
8. 개인정보 포털 상담사례 : https://www.privacy.go.kr/front/case/list.do
