...
| Layer C 코퍼스 BM25 인덱스 (2,699 청크) | 부팅 시 1회 빌드 | 메모리 (lazy singleton) |
...
| `search_privacy_guides` | `query` · `doc_type`=all · `display` | PIPC 공식 가이드 7종. `doc_type` qa(99) / small_business(41) / cctv(71) / sectoral(476, 8개 편 전체) / pseudonym(132) / privacy_policy(96) / public_ax(39) / all(954). |
