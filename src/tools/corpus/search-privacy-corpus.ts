...
export const searchPrivacyCorpus: Tool<typeof inputSchema> = {
  ...
  description:
    "PIPC 공식 가이드 7종(질의응답·소상공인·CCTV·분야별 안내서 8개 편 전체·가명정보 처리 가이드라인 2026.3·개인정보 처리방침 작성지침 2026.4·공공 AX 프라이버시 보호 안내서 2026.7) + privacy.go.kr 상담사례 1,745건 통합 BM25 검색 (총 2,699 청크, Contextual Retrieval 적용). " +
